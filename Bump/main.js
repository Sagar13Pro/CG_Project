...
onload = function init() {
    ...
    var vTexCoordB = gl.getAttribLocation(program, "vTexCoordB");
    gl.vertexAttribPointer(vTexCoordB, 2, gl.FLOAT, false, 0, 0);
    gl.enableVertexAttribArray(vTexCoordB);

    configureTexture(normalsB);
    ...
    gl.uniform4fv(gl.getUniformLocation(program, "normalB"), flatten(normal));
    gl.uniform3fv(gl.getUniformLocation(program, "objTangentB"), flatten(tangent));

    gl.uniform4fv(gl.getUniformLocation(program, "ambientProduct"), flatten(ambientProduct));
    gl.uniform4fv(gl.getUniformLocation(program, "diffuseProductB"), flatten(diffuseProduct));
